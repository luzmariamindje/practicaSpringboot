...
public class PracticaController {
	...
	@GetMapping(path = "tablaCliente")
	public String tablaCliente(Model model) {
		model.addAttribute("insert", "insertar clientes");
		model.addAttribute("cliente", clientesRepository.findAll());
		return "mostraTaula";
	}
	...
	public String delete(Model model, @RequestParam long idClientes) {
		...
		return "redirect:/practica/tablaCliente";
	}
